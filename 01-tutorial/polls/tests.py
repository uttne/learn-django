...
class QuestionModelTests(TestCase):
    def test_was_published_recently_with_future_question(self):
        """
        was_published_recently() returns False for questions whose pub_date is in the futuer.
        """
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_future_question_adn_past_question(self):
        """
        Even if both past and futer questions exist, only past questions are displayed.
        """
        question = create_question(question_text="Past question.", days=-30)
